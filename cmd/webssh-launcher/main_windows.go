...
func main() {
	...
	// a brand new console window to make up for that. (A theory that this
	// poisons the Terminal button's later interop console launches turned
	// out moot once Terminal settled on cmd.exe, which already worked fine
	// alongside this flag before PowerShell was tried and dropped.)
